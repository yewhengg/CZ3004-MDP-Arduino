...
{
  // tune sensor range
  float Front1_RANGE[3] = {10, 17, 25};
  float Front2_RANGE[3] = {10, 17, 25};
  float Front3_RANGE[3] = {10, 17, 25};
  float Left1_RANGE[3] = {10, 17, 25};
  float Left2_RANGE[3] = {10, 17, 25};
  float Right1_RANGE[3] = {10, 17, 25};
  sensorOutput = "r";
  debugOutput = "d";
  counter = 0;
  ...
  srSensorRight1Distance = round(srSensorRight1DistanceRM.getAverage(5));
  if (srSensorRight1Distance <= Right1_RANGE[0])
  {
    srSensorRight1DistanceOutput = -1;
  }
  else if (srSensorRight1Distance <= Right1_RANGE[1])
  {
    srSensorRight1DistanceOutput = 1;
  }
  else if (srSensorRight1Distance <= Right1_RANGE[2])
  {
    srSensorRight1DistanceOutput = 2;
  }
  else
  {
    srSensorRight1DistanceOutput = 0;
  }
